...
@objc public protocol TextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: TextView, height: CGFloat)
}
...
open class TextView: UITextView {
    ...
    @IBInspectable var paddingLeftCustom: CGFloat = 8 {
        didSet {
            self.textContainerInset = UIEdgeInsets(top: paddingTopCustom, left: paddingLeftCustom, bottom: paddingBottomCustom, right: paddingRightCustom)
        }
    }

    @IBInspectable var paddingRightCustom: CGFloat = 8 {
        didSet {
            self.textContainerInset = UIEdgeInsets(top: paddingTopCustom, left: paddingLeftCustom, bottom: paddingBottomCustom, right: paddingRightCustom)
        }
    }
    
    @IBInspectable var paddingTopCustom: CGFloat = 8 {
        didSet {
            self.textContainerInset = UIEdgeInsets(top: paddingTopCustom, left: paddingLeftCustom, bottom: paddingBottomCustom, right: paddingRightCustom)
        }
    }

    @IBInspectable var paddingBottomCustom: CGFloat = 8 {
        didSet {
            self.textContainerInset = UIEdgeInsets(top: paddingTopCustom, left: paddingLeftCustom, bottom: paddingBottomCustom, right: paddingRightCustom)
        }
    }
